...
res=obj.get('result',{})
print('run_id:', res.get('run_id'))
print('result_path:', obj.get('result_path') or res.get('result_path'))
print('conclusion_path:', obj.get('conclusion_path') or res.get('conclusion_path'))
print('verdict:', (res.get('conclusion') or {}).get('verdict'))
PY
